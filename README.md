YiiReCaptcha 
============
Based on reCaptcha API 2.0, forked of dakiquang/yiiReCaptcha

## Quick Start

You can clone the [github repo](https://github.com/novakom-devel/yiiReCaptcha) and get the full codebase to build the distributive something you want. 

## Installation
* 1/ Download GitHub repo (novakom-devel/yiiReCaptcha) and extract files into a destination folder(extensions folder/vendor folder or any folder in your structure)
